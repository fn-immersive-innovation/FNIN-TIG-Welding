...
public class WeldingMachine : MonoBehaviour
{
    ...
    private void Update()
    {
        Debug.Log("weld: " + m_AppManager.canWeld);
        if (!m_AppManager.canWeld) return;
        Debug.Log("touch: " + isTouchingWeldObject);
        ...
        emission.rateOverTimeMultiplier = (m_AppManager.weldVoltage * 1000) + 500;
    }
