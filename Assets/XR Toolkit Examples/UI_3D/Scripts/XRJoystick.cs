...
namespace UnityEngine.XR.Content.Interaction
{
    ...
    public class XRJoystick : XRBaseInteractable
    {
        ...
        void Start()
        {
            m_StartRotation = m_Handle.rotation.eulerAngles;
        ...
        void SetHandleAngle(Vector2 angles)
        {
            ...
            // Calculate the new rotation quaternion based on the updated forward vector
            Quaternion newRotation = Quaternion.Euler(angles.y, 0, angles.x);

            // Apply the new rotation to the handle
            m_Handle.localRotation = newRotation;
